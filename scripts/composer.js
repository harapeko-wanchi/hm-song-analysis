...
const COMPOSER_PROFILES = {
  'NNBS.': {
    ...
    role: 'カタログ全33曲中19曲を担当し、Hey!Mommy!サウンドの"基準点（デフォルト）"を形成。高BPM×打ち込み×ナンセンスワードという三位一体のスタイルで、ライブ映えするパーティーチューンを量産してきた。レーダーチャートでは「お祭り感」「子供心」「疾走感」が顕著に高く、グループの"全力はしゃぎ！"を音楽的に体現する存在。',
    ...
    evolution: '初期作品（BEACH! BEACH!、Hey!Baby!等）ではI-V-vi-IVの王道進行やシンプルな3〜4コード循環で「まっすぐなハッピー」を量産。中期（GALAXY! GALAXY!、POJI POJI GO）でI7/♭7シグネチャーを確立し、クロマティック・メディアント揺動（E↔G）やフリジアン色など和声パレットを拡大。PLAYFUL ROMANTICでは全音階7音下行バスという前例のない手法を導入し、セルフタイトルアンセムとして楽曲メドレー歌詞まで盛り込んだ。MY FIRST LOVE SONGではBPM220のカタログ最速バンドポップでC→Ab長3度下転調とクロマティック間奏を駆使し、全編英語→日本語Dメロの二層構造で新境地を開拓。さらに夜空ウィズユーではBPM100のカタログ最遅ラブバラードに初挑戦し、iii・iiの使い分けで繊細な感情を描くなど——手法は確実に深化し続けている。',
    bpmNote: 'BPM帯は100〜220と極めて幅広いが、180〜200の超高速域に集中する傾向。BPM220のMY FIRST LOVE SONG（カタログ最速）、BPM210のHey! get up kids、BPM206のビスケットケースなど最速クラスを多数保有する一方、BPM100の夜空ウィズユー（カタログ最遅）でバラード領域にも踏み込んだ。',
